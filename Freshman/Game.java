...
class Game extends Frame implements MouseListener, KeyListener {
	...
	int stuff[][]={{725,1350,51,200,0,0,0,0},{50,20,-3,25,3,0,0,0},{1400,140,-3,25,3,0,0,0},{1400,830,-3,25,3,0,0,0}
			...
			,{670,730,-1,7,3,0,0,0},{870,240,-1,7,3,0,0,0},{960,670,-1,7,3,0,0,0},{50,930,-1,50,3,0,0,0}
	...
	public void readlevel(String part) {
		try {
			int position=0; thereturn=new String[30];
			RandomAccessFile leveldat = new RandomAccessFile(
				"levels/level" + level + ".dat","r");
			System.out.println("levels/level" + level + ".dat");
